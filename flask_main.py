...
portfolio_items["How To Build A Planet"] = PortfolioItem("Game Jam")
portfolio_items["How To Build A Planet"].shorttext = "Ludum Dare 38"
portfolio_items["How To Build A Planet"].logo = UNITY_LOGO
portfolio_items["How To Build A Planet"].content = """Game made for Ludum Dare game jam 38, the theme was 'Small World'. You start off on an asteroid and you must place rockets at
 the edge to thrust it off into space and connecting to other asteroids to increase the size of your planet and gain more resources.
...
Two friends and I made this in Unity over a weekend: John Roberts (<a href="http://www.twitter.com/Thingus49">@Thingus49</a>) and Timothy Threadgold (<a 
	href="http://www.twitter.com/TimThreadgold">@TimThreadgold</a>), I don't think the resolution scaling works too well - we assumed Unity did everything and then we were too 
burned out on the Sunday night to fix it."""
portfolio_items["How To Build A Planet"].images = [ "asteroid1.png" ]
portfolio_items["How To Build A Planet"].links = { "itch.io" : "https://alexdiru.itch.io/how-to-build-a-planet" }

portfolio_items["Cabin Commander"] = PortfolioItem("Game Jam")
portfolio_items["Cabin Commander"].shorttext = "Ludum Dare 37"
portfolio_items["Cabin Commander"].logo = UNITY_LOGO
portfolio_items["Cabin Commander"].content = """Game made for Ludum Dare game jam 37, the theme was 'One Room'. You play the role of a commander locked in a cabin on a 
battlefield. You are able to control your tanks from the commander table in your cabin and can look outside your cabin onto the battlefield, but you can never leave your cabin.

Two friends and I made this in Unity over a weekend: John Roberts (<a href="http://www.twitter.com/Thingus49">@Thingus49</a>) and Timothy Threadgold (<a 
href="http://www.twitter.com/TimThreadgold">@TimThreadgold</a>)."""
portfolio_items["Cabin Commander"].images = [ "cabin1.png" ]
portfolio_items["Cabin Commander"].links = { "itch.io" : "https://alexdiru.itch.io/cabin-commander" }

portfolio_items["Omega"] = PortfolioItem("Game Jam")
